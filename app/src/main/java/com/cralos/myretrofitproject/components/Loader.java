package com.cralos.myretrofitproject.components;
...
public class Loader extends DialogFragment {
    public static final String TGA = Loader.class.getSimpleName();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        getDialog().getWindow().setBackgroundDrawableResource(R.color.backgroundTransparent);
        setCancelable(false);
        return view;
    }
